import geometricPrimitives.Square;
...
/**
 * A class implementing the behavior of an animated square
 * @author Li Wing Yee
 */
public class AnimatedSquares extends Square implements ColorAnimation, GravityAffected {
	private Color targetColor;
	
	/**
	 * Constructor of an animated square<br>
	 ...
	 */
	public AnimatedSquares(int x, int y, Color c, int s) {
		super(x, y, c, s);
		targetColor = c;
	}
